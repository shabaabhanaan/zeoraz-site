                  ...
                  >
                    ...
                    <motion.div variants={childVariants} className="space-y-4">
                      ...
                      <div className="flex items-center gap-4 my-2">
                        ...
                        <span className="text-[10px] font-bold tracking-wider text-slate-500 uppercase">Or continue with</span>
                        <div className="h-px flex-1 bg-slate-800"></div>
                      </div>

                      <button
                        type="button"
                        className="w-full flex items-center justify-center gap-3 py-3.5 bg-slate-900 border border-slate-800 hover:bg-slate-800 text-white rounded-xl font-bold transition-all duration-300"
                        onClick={() => {
