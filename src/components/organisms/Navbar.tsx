        ...
        {isOpen && (
          ...
          >
            ...
            <button
              ...
              className="w-full py-3.5 rounded-full bg-[#2563eb] hover:bg-[#1d4ed8] text-white text-sm font-bold text-center shadow-lg shadow-blue-500/25 transition-all cursor-pointer"
            >
              Talk to Us
            </button>
          </motion.div>
